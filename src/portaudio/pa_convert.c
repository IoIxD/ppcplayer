                                                ...
                                                PaSampleFormat targetFormat, int ifClip, int ifDither)
{
    ...
    case paFloat32:
        ...
        case paInt8:
            if (ifClip && ifDither)
                proc = (PortAudioConverter *)PaConvert_Float32_Int8_ClipDither;
            else if (ifClip)
                proc = (PortAudioConverter *)PaConvert_Float32_Int8_Clip;
            else if (ifDither)
                proc = (PortAudioConverter *)PaConvert_Float32_Int8_Dither;
            else
                proc = (PortAudioConverter *)PaConvert_Float32_Int8;
            break;
        case paInt16:
            if (ifClip && ifDither)
                proc = (PortAudioConverter *)PaConvert_Float32_Int16_ClipDither;
            else if (ifClip)
                proc = (PortAudioConverter *)PaConvert_Float32_Int16_Clip;
            else if (ifDither)
                proc = (PortAudioConverter *)PaConvert_Float32_Int16_Dither;
            else
                proc = (PortAudioConverter *)PaConvert_Float32_Int16;
            break;
        case paInt32:
            /* Don't bother dithering a 32 bit integer! */
            if (ifClip)
                proc = (PortAudioConverter *)PaConvert_Float32_Int32_Clip;
            else
                proc = (PortAudioConverter *)PaConvert_Float32_Int32;
            break;
        default:
            break;
        }
                             ...
                             PaSampleFormat nativeInputSampleFormat)
{
    ...
    if (nativeInputSampleFormat != past->past_InputSampleFormat)
    {
        ...
        if (past->past_InputConversionProc == NULL)
                              ...
                              PaSampleFormat nativeOutputSampleFormat)
{
    ...
    if (nativeOutputSampleFormat != past->past_OutputSampleFormat)
    {
        ...
        if (past->past_OutputConversionProc == NULL)
            return paSampleFormatNotSupported;
    }
    else
    {
                       ...
                       void *nativeOutputBuffer)
{
    ...
    {
        outputBuffer = (past->past_OutputConversionProc == NULL) ? nativeOutputBuffer : past->past_OutputBuffer;
    }
    /*
