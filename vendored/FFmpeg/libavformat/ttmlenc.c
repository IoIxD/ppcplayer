                            ...
                            int64_t millisec)
{
    ...
    avio_printf(pb, "%s=\"02ulld:02ulld:02ulld.03ulld\"",
...
static int ttml_write_header(AVFormatContext *ctx)
{
    ...
    ttml_ctx->input_type = ff_is_ttml_stream_paragraph_based(st->codecpar) ? PACKET_TYPE_PARAGRAPH : PACKET_TYPE_DOCUMENT;
