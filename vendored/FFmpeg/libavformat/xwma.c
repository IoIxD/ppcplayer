...
static int xwma_read_header(AVFormatContext *s)
{
    ...
    {
        int64_t cur_pos;
        const uint32_t bytes_per_sample = (st->codecpar->ch_layout.nb_channels * st->codecpar->bits_per_coded_sample) >> 3;
