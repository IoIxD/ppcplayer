                                     ...
                                     int stream_index, int64_t duration)
{
    ...
    if (sti->first_dts != AV_NOPTS_VALUE)
    {
        ...
        {
            av_log(s, AV_LOG_DEBUG, "first_dts %s not matching first dts %s (pts %s, duration %lld) in the queue\n",
                               ...
                               int64_t next_dts, int64_t next_pts)
{
    ...
    {
        av_log(s, AV_LOG_DEBUG, "invalid dts/pts combination %lld\n", pkt->dts);
...
static void estimate_timings(AVFormatContext *ic, int64_t old_offset)
{
    ...
    av_log(ic, AV_LOG_TRACE,
           "format: start_time: %s duration: %s (estimate from %s) bitrate=%lld kb/s\n",
...
int avformat_find_stream_info(AVFormatContext *ic, AVDictionary **options)
{
    ...
    if (ic->pb)
    {
        ...
        av_log(ic, AV_LOG_DEBUG, "Before avformat_find_stream_info() pos: %lld bytes read:%lld seeks:%d nb_streams:%d\n",
