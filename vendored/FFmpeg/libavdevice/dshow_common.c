...
void ff_print_VIDEO_STREAM_CONFIG_CAPS(const VIDEO_STREAM_CONFIG_CAPS *caps)
{
    ...
    dshowdebug("  MinFrameInterval\t%lld\n", caps->MinFrameInterval);
    dshowdebug("  MaxFrameInterval\t%lld\n", caps->MaxFrameInterval);
    dshowdebug("  MinBitsPerSecond\t%lld\n", caps->MinBitsPerSecond);
    dshowdebug("  MaxBitsPerSecond\t%lld\n", caps->MaxBitsPerSecond);
#endif
}
