...
static const AVOption tonemap_vaapi_options[] = {
    ...
    {"matrix", "Output color matrix coefficient set", OFFSET(color_matrix_string), AV_OPT_TYPE_STRING, {.str = NULL}, .flags = FLAGS, .unit = "matrix"},
    {"m", "Output color matrix coefficient set", OFFSET(color_matrix_string), AV_OPT_TYPE_STRING, {.str = NULL}, .flags = FLAGS, .unit = "matrix"},
    {"primaries", "Output color primaries set", OFFSET(color_primaries_string), AV_OPT_TYPE_STRING, {.str = NULL}, .flags = FLAGS, .unit = "primaries"},
    {"p", "Output color primaries set", OFFSET(color_primaries_string), AV_OPT_TYPE_STRING, {.str = NULL}, .flags = FLAGS, .unit = "primaries"},
    {"transfer", "Output color transfer characteristics set", OFFSET(color_transfer_string), AV_OPT_TYPE_STRING, {.str = NULL}, .flags = FLAGS, .unit = "transfer"},
    ...
    {"display", "set mastering display colour volume", OFFSET(mastering_display), AV_OPT_TYPE_STRING, {.str = NULL}, .flags = FLAGS},
    {"light", "set content light level information", OFFSET(content_light), AV_OPT_TYPE_STRING, {.str = NULL}, .flags = FLAGS},
    {NULL}};
