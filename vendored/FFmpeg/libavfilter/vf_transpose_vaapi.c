...
static AVFrame *get_video_buffer(AVFilterLink *inlink, int w, int h)
{
    ...
    return ctx->passthrough ? ff_null_get_video_buffer(inlink, w, h) : ff_default_get_video_buffer(inlink, w, h);
}
...
static const AVOption transpose_vaapi_options[] = {
    ...
    {"passthrough", "do not apply transposition if the input matches the specified geometry", OFFSET(passthrough), AV_OPT_TYPE_INT, {.i64 = TRANSPOSE_PT_TYPE_NONE}, 0, INT_MAX, FLAGS, .unit = "passthrough"},
