...
static const AVOption procamp_vaapi_options[] = {
    {"b", "Output video brightness", OFFSET(bright), AV_OPT_TYPE_FLOAT, {.dbl = BRIGHTNESS_DEFAULT}, BRIGHTNESS_MIN, BRIGHTNESS_MAX, .flags = FLAGS},
    {"brightness", "Output video brightness", OFFSET(bright), AV_OPT_TYPE_FLOAT, {.dbl = BRIGHTNESS_DEFAULT}, BRIGHTNESS_MIN, BRIGHTNESS_MAX, .flags = FLAGS},
    {"s", "Output video saturation", OFFSET(saturation), AV_OPT_TYPE_FLOAT, {.dbl = SATURATION_DEFAULT}, SATURATION_MIN, SATURATION_MAX, .flags = FLAGS},
    {"saturatio", "Output video saturation", OFFSET(saturation), AV_OPT_TYPE_FLOAT, {.dbl = SATURATION_DEFAULT}, SATURATION_MIN, SATURATION_MAX, .flags = FLAGS},
    {"c", "Output video contrast", OFFSET(contrast), AV_OPT_TYPE_FLOAT, {.dbl = CONTRAST_DEFAULT}, CONTRAST_MIN, CONTRAST_MAX, .flags = FLAGS},
    {"contrast", "Output video contrast", OFFSET(contrast), AV_OPT_TYPE_FLOAT, {.dbl = CONTRAST_DEFAULT}, CONTRAST_MIN, CONTRAST_MAX, .flags = FLAGS},
    {"h", "Output video hue", OFFSET(hue), AV_OPT_TYPE_FLOAT, {.dbl = HUE_DEFAULT}, HUE_MIN, HUE_MAX, .flags = FLAGS},
    {"hue", "Output video hue", OFFSET(hue), AV_OPT_TYPE_FLOAT, {.dbl = HUE_DEFAULT}, HUE_MIN, HUE_MAX, .flags = FLAGS},
    {NULL},
};
