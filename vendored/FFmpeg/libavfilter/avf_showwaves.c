...
static int config_output(AVFilterLink *outlink)
{
    ...
    case AV_PIX_FMT_GRAY8:
        ...
        {
        case MODE_POINT:
            showwaves->draw_sample = draw_sample_point_gray;
            break;
        case MODE_LINE:
            showwaves->draw_sample = draw_sample_line_gray;
            break;
        case MODE_P2P:
            showwaves->draw_sample = draw_sample_p2p_gray;
            break;
        case MODE_CENTERED_LINE:
            showwaves->draw_sample = draw_sample_cline_gray;
            break;
        default:
            return AVERROR_BUG;
        }
    ...
    case AV_PIX_FMT_RGBA:
        ...
        {
        case MODE_POINT:
            showwaves->draw_sample = showwaves->draw_mode == DRAW_SCALE ? draw_sample_point_rgba_scale : draw_sample_point_rgba_full;
            break;
        case MODE_LINE:
            showwaves->draw_sample = showwaves->draw_mode == DRAW_SCALE ? draw_sample_line_rgba_scale : draw_sample_line_rgba_full;
            break;
        case MODE_P2P:
            showwaves->draw_sample = showwaves->draw_mode == DRAW_SCALE ? draw_sample_p2p_rgba_scale : draw_sample_p2p_rgba_full;
            break;
        case MODE_CENTERED_LINE:
            showwaves->draw_sample = showwaves->draw_mode == DRAW_SCALE ? draw_sample_cline_rgba_scale : draw_sample_cline_rgba_full;
            break;
        default:
            return AVERROR_BUG;
        }
    ...
    case SCALE_LIN:
        ...
        case MODE_LINE:
        case MODE_P2P:
            showwaves->get_h = get_lin_h;
            break;
        case MODE_CENTERED_LINE:
            showwaves->get_h = get_lin_h2;
            break;
        default:
            return AVERROR_BUG;
        }
    ...
    case SCALE_LOG:
        ...
        case MODE_LINE:
        case MODE_P2P:
            showwaves->get_h = get_log_h;
            break;
        case MODE_CENTERED_LINE:
            showwaves->get_h = get_log_h2;
            break;
        default:
            return AVERROR_BUG;
        }
    ...
    case SCALE_SQRT:
        ...
        case MODE_LINE:
        case MODE_P2P:
            showwaves->get_h = get_sqrt_h;
            break;
        case MODE_CENTERED_LINE:
            showwaves->get_h = get_sqrt_h2;
            break;
        default:
            return AVERROR_BUG;
        }
    ...
    case SCALE_CBRT:
        ...
        case MODE_LINE:
        case MODE_P2P:
            showwaves->get_h = get_cbrt_h;
            break;
        case MODE_CENTERED_LINE:
            showwaves->get_h = get_cbrt_h2;
            break;
        default:
            return AVERROR_BUG;
        }
...
static int push_single_pic(AVFilterLink *outlink)
{
    ...
    av_log(ctx, AV_LOG_DEBUG, "Create frame averaging %lld samples per column\n", column_max_samples);
