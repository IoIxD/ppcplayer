                                      ...
                                      CFStringRef *profile_level_val)
{
    ...
    *profile_level_val = NULL;
    ...
    case AV_PROFILE_H264_BASELINE:
        ...
        case 0:
            *profile_level_val =
            ...
            break;
        case 13:
            *profile_level_val = kVTProfileLevel_H264_Baseline_1_3;
            break;
        case 30:
            *profile_level_val = kVTProfileLevel_H264_Baseline_3_0;
            break;
        case 31:
            *profile_level_val = kVTProfileLevel_H264_Baseline_3_1;
            break;
        case 32:
            *profile_level_val = kVTProfileLevel_H264_Baseline_3_2;
            break;
        case 40:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_Baseline_4_0;
            break;
        case 41:
            *profile_level_val = kVTProfileLevel_H264_Baseline_4_1;
            break;
        case 42:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_Baseline_4_2;
            break;
        case 50:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_Baseline_5_0;
            break;
        case 51:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_Baseline_5_1;
            break;
        case 52:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_Baseline_5_2;
            break;
        }
        break;
    ...
    case AV_PROFILE_H264_MAIN:
        ...
        case 0:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_Main_AutoLevel;
            break;
        case 30:
            *profile_level_val = kVTProfileLevel_H264_Main_3_0;
            break;
        case 31:
            *profile_level_val = kVTProfileLevel_H264_Main_3_1;
            break;
        case 32:
            *profile_level_val = kVTProfileLevel_H264_Main_3_2;
            break;
        case 40:
            *profile_level_val = kVTProfileLevel_H264_Main_4_0;
            break;
        case 41:
            *profile_level_val = kVTProfileLevel_H264_Main_4_1;
            break;
        case 42:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_Main_4_2;
            break;
        case 50:
            *profile_level_val = kVTProfileLevel_H264_Main_5_0;
            break;
        case 51:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_Main_5_1;
            break;
        case 52:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_Main_5_2;
            break;
        }
        break;
    ...
    case AV_PROFILE_H264_HIGH:
        ...
        case 30:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_High_3_0;
            break;
        case 31:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_High_3_1;
            break;
        case 32:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_High_3_2;
            break;
        case 40:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_High_4_0;
            break;
        case 41:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_High_4_1;
            break;
        case 42:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_High_4_2;
            break;
        case 50:
            *profile_level_val = kVTProfileLevel_H264_High_5_0;
            break;
        case 51:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_High_5_1;
            break;
        case 52:
            *profile_level_val =
    ...
    case AV_PROFILE_H264_EXTENDED:
        ...
        case 0:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_Extended_AutoLevel;
            break;
        case 50:
            *profile_level_val =
                compat_keys.kVTProfileLevel_H264_Extended_5_0;
            break;
        }
        break;
    }
                               ...
                               int *range_guessed)
{
    ...
    if (range_guessed)
        *range_guessed = range != AVCOL_RANGE_MPEG &&
                                ...
                                VTCompressionSessionRef *session)
{
    ...
    if (__builtin_available(macOS 10.13, *))
    {
        ...
        if (status != noErr)
        {
            av_log(avctx, AV_LOG_ERROR, "Error retrieving the supported property dictionary err=%lld\n", (int64_t)status);
            return AVERROR_EXTERNAL;
        }
    }
#endif
    ...
    if ((vtctx->codec_id == AV_CODEC_ID_H264 || vtctx->codec_id == AV_CODEC_ID_HEVC) && max_rate > 0)
    {
    ...
    {
        CFStringRef entropy = vtctx->entropy == VT_CABAC ? compat_keys.kVTH264EntropyMode_CABAC : compat_keys.kVTH264EntropyMode_CAVLC;
...
static int vtenc_configure_encoder(AVCodecContext *avctx)
{
    ...
    if (vtctx->codec_id == AV_CODEC_ID_H264)
    {
        ...
        if (!get_vt_h264_profile_level(avctx, &profile_level))
            return AVERROR(EINVAL);
    }
    else if (vtctx->codec_id == AV_CODEC_ID_HEVC)
    {
        ...
        if (!vtctx->get_param_set_func)
            return AVERROR(EINVAL);
        if (!get_vt_hevc_profile_level(avctx, &profile_level))
            return AVERROR(EINVAL);
        // HEVC has b-byramid
...
#define COMMON_OPTIONS                                                                                                                                                                         \
    {"allow_sw", "Allow software encoding", OFFSET(allow_sw), AV_OPT_TYPE_BOOL, {.i64 = 0}, 0, 1, VE},                                                                                         \
        ...
        {"realtime", "Hint that encoding should happen in real-time if not faster (e.g. capturing from camera).", OFFSET(realtime), AV_OPT_TYPE_BOOL, {.i64 = 0}, -1, 1, VE},                  \
        {"frames_before", "Other frames will come before the frames in this session. This helps smooth concatenation issues.", OFFSET(frames_before), AV_OPT_TYPE_BOOL, {.i64 = 0}, 0, 1, VE}, \
        {"frames_after", "Other frames will come after the frames in this session. This helps smooth concatenation issues.", OFFSET(frames_after), AV_OPT_TYPE_BOOL, {.i64 = 0}, 0, 1, VE},    \
        {"prio_speed", "prioritize encoding speed", OFFSET(prio_speed), AV_OPT_TYPE_BOOL, {.i64 = -1}, -1, 1, VE},                                                                             \
        {"power_efficient", "Set to 1 to enable more power-efficient encoding if supported.", OFFSET(power_efficient), AV_OPT_TYPE_INT, {.i64 = -1}, -1, 1, VE},                               \
        {"max_ref_frames",                                                                                                                                                                     \
