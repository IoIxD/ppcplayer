...
static const AVOption cbs_av1_options[] = {
    {"operating_point", "Set operating point to select layers to parse from a scalable bitstream", OFFSET(operating_point), AV_OPT_TYPE_INT, {.i64 = -1}, -1, AV1_MAX_OPERATING_POINTS - 1, 0},
    {"fixed_obu_size_length", "Set fixed length of the obu_size field", OFFSET(fixed_obu_size_length), AV_OPT_TYPE_INT, {.i64 = 0}, 0, 8, 0},
    {NULL}};
