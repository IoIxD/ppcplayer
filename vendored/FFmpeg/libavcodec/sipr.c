...
static const SiprModeParam modes[MODE_COUNT] = {
    ...
    [MODE_8k5] = {.mode_name = "8k5", .bits_per_frame = 152, .subframe_count = 3, .frames_per_packet = 1, .pitch_sharp_factor = 0.8,
    ...
    [MODE_6k5] = {.mode_name = "6k5", .bits_per_frame = 232, .subframe_count = 3, .frames_per_packet = 2, .pitch_sharp_factor = 0.8,
    ...
    [MODE_5k0] = {.mode_name = "5k0", .bits_per_frame = 296, .subframe_count = 5, .frames_per_packet = 2, .pitch_sharp_factor = 0.85,
    ...
    case MODE_8k5:
        for (i = 0; i < 3; i++)
        {
            ...
            fixed_sparse->y[2 * i + 1] =
                (fixed_sparse->x[2 * i + 1] < fixed_sparse->x[2 * i]) ? -fixed_sparse->y[2 * i] : fixed_sparse->y[2 * i];
        }
