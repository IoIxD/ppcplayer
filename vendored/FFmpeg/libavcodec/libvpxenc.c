...
static int frame_data_apply(AVCodecContext *avctx, AVFifo *fifo, AVPacket *pkt)
{
    ...
    if (fd.pts != pkt->pts)
    {
        av_log(avctx, AV_LOG_WARNING,
               "Mismatching timestamps: libvpx %lld queued %lld; "
    ...
    {"lag-in-frames", "Number of frames to look ahead for "                                                                                                                    \
     ...
     VE},                                                                                                                                                                      \
        ...
        {"partitions", "The frame partitions are independently decodable "                                                                                                     \
         ...
         0,                                                                                                                                                                    \
         AV_OPT_TYPE_CONST,                                                                                                                                                    \
         {.i64 = VPX_ERROR_RESILIENT_PARTITIONS},                                                                                                                              \
         0,                                                                                                                                                                    \
         0,                                                                                                                                                                    \
         VE,                                                                                                                                                                   \
         .unit = "er"},                                                                                                                                                        \
...
static const AVOption vp8_options[] = {
    COMMON_OPTIONS{"auto-alt-ref", "Enable use of alternate reference "
                                   "frames (2-pass only)",
                   OFFSET(auto_alt_ref),
                   AV_OPT_TYPE_INT,
                   {.i64 = -1},
