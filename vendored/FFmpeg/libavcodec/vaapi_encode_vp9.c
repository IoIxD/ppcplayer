                                                ...
                                                VAAPIEncodePicture *vaapi_pic)
{
    ...
    {
        av_log(avctx, AV_LOG_DEBUG, "Pic %lld not stored.\n",
               pic->display_order);
    }
    else
    {
        av_log(avctx, AV_LOG_DEBUG, "Pic %lld stored in slot %d.\n",
...
static const AVOption vaapi_encode_vp9_options[] = {
    ...
    {"loop_filter_level", "Loop filter level", OFFSET(loop_filter_level), AV_OPT_TYPE_INT, {.i64 = 16}, 0, 63, FLAGS},
    {"loop_filter_sharpness", "Loop filter sharpness", OFFSET(loop_filter_sharpness), AV_OPT_TYPE_INT, {.i64 = 4}, 0, 15, FLAGS},
    {NULL},
};
