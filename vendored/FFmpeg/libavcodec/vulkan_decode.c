...
static const VkVideoProfileInfoKHR *get_video_profile(FFVulkanDecodeShared *ctx, enum AVCodecID codec_id)
{
    ...
    VkStructureType profile_struct_type =
        codec_id == AV_CODEC_ID_H264 ? VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_PROFILE_INFO_KHR : codec_id == AV_CODEC_ID_HEVC ? VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_PROFILE_INFO_KHR
                                 ...
                                 VkFormat vkf, int is_current)
{
    ...
    VkImageViewCreateInfo img_view_create_info = {
        ...
        .viewType = dec->layered_dpb && !is_current ? VK_IMAGE_VIEW_TYPE_2D_ARRAY : VK_IMAGE_VIEW_TYPE_2D,
        .format = vkf,
        .image = src->img[0],
        ...
        .subresourceRange = (VkImageSubresourceRange){
            ...
            .baseArrayLayer = 0,
            .layerCount = dec->layered_dpb && !is_current ? VK_REMAINING_ARRAY_LAYERS : 1,
            .levelCount = 1,
        },
    };
                       ...
                       AVFrame *rpic[], FFVulkanDecodePicture *rvkp[])
{
    ...
    if (dec->exec_pool.nb_queries)
    {
        ...
        if (ret == VK_SUCCESS)
            av_log(avctx, prev_sub_res < 0 ? AV_LOG_ERROR : AV_LOG_DEBUG,
                   "Result of previous frame decoding: %lld\n", prev_sub_res);
    }
    ...
    img_bar[nb_img_bar] = (VkImageMemoryBarrier2){
        ...
        .newLayout = (dec->layered_dpb || vp->dpb_frame) ? VK_IMAGE_LAYOUT_VIDEO_DECODE_DST_KHR : VK_IMAGE_LAYOUT_VIDEO_DECODE_DPB_KHR, /* Spec, 07252 utter madness */
                                     ...
                                     int *dpb_dedicate)
{
    ...
    base_profile = avctx->codec_id == AV_CODEC_ID_H264 ? AV_PROFILE_H264_CONSTRAINED_BASELINE : avctx->codec_id == AV_CODEC_ID_H265 ? AV_PROFILE_HEVC_MAIN
    ...
    max_level = avctx->codec_id == AV_CODEC_ID_H264 ? ff_vk_h264_level_to_av(h264_caps.maxLevelIdc) : avctx->codec_id == AV_CODEC_ID_H265 ? ff_vk_h265_level_to_av(h265_caps.maxLevelIdc)
    ...
    av_log(avctx, AV_LOG_VERBOSE, "    Decode modes:%s%s%s\n",
           ...
           dec_caps->flags & VK_VIDEO_DECODE_CAPABILITY_DPB_AND_OUTPUT_COINCIDE_BIT_KHR ? " reuse_dst_dpb" : "",
           dec_caps->flags & VK_VIDEO_DECODE_CAPABILITY_DPB_AND_OUTPUT_DISTINCT_BIT_KHR ? " dedicated_dpb" : "");
    av_log(avctx, AV_LOG_VERBOSE, "    Capability flags:%s%s%s\n",
           caps->flags ? "" : " none",
           caps->flags & VK_VIDEO_CAPABILITY_PROTECTED_CONTENT_BIT_KHR ? " protected" : "",
           caps->flags & VK_VIDEO_CAPABILITY_SEPARATE_REFERENCE_IMAGES_BIT_KHR ? " separate_references" : "");
...
int ff_vk_decode_init(AVCodecContext *avctx)
{
    ...
    VkVideoSessionParametersCreateInfoKHR session_params_create = {
        ...
        .pNext = avctx->codec_id == AV_CODEC_ID_H264 ? (void *)&h264_params : avctx->codec_id == AV_CODEC_ID_HEVC ? (void *)&h265_params
