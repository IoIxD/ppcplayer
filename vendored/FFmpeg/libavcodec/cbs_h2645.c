                                  ...
                                  CodedBitstreamUnit *unit)
{
    ...
    {
        err = (unit->type == H264_NAL_END_SEQUENCE ? cbs_h264_read_end_of_sequence : cbs_h264_read_end_of_stream)(ctx, &gbc, unit->content);
        if (err < 0)
            return err;
    }
    break;
...
static const CodedBitstreamUnitTypeDescriptor cbs_h266_unit_types[] = {
    ...
    CBS_UNIT_RANGE_INTERNAL_REF(VVC_TRAIL_NUT, VVC_RASL_NUT, H266RawSlice, data),

    CBS_UNIT_RANGE_INTERNAL_REF(VVC_IDR_W_RADL, VVC_GDR_NUT, H266RawSlice, data),

    CBS_UNIT_TYPES_COMPLEX((VVC_PREFIX_SEI_NUT, VVC_SUFFIX_SEI_NUT), H266RawSEI, cbs_h266_free_sei),
