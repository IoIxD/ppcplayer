...
cglobal xavs_pixel_sad_16x16_sse2
cglobal xavs_pixel_sad_16x8_sse2
cglobal xavs_pixel_sad_x3_16x16_sse2
cglobal xavs_pixel_sad_x3_16x8_sse2
cglobal xavs_pixel_sad_x4_16x16_sse2
cglobal xavs_pixel_sad_x4_16x8_sse2
cglobal xavs_pixel_ssd_16x16_sse2
cglobal xavs_pixel_ssd_16x8_sse2
cglobal xavs_pixel_satd_8x4_sse2
cglobal xavs_pixel_satd_8x8_sse2
cglobal xavs_pixel_satd_16x8_sse2
cglobal xavs_pixel_satd_8x16_sse2
cglobal xavs_pixel_satd_16x16_sse2
...
ALIGN 16
;-----------------------------------------------------------------------------
;   int __cdecl xavs_pixel_sad_16x16_sse2 (uint8_t *, int, uint8_t *, int )
;-----------------------------------------------------------------------------
xavs_pixel_sad_16x16_sse2:
    SAD_START_SSE2
    movdqu xmm0, [ecx]
    movdqu xmm1, [ecx+edx]
    lea    ecx,  [ecx+2*edx]
...
ALIGN 16
;-----------------------------------------------------------------------------
;   int __cdecl xavs_pixel_sad_16x8_sse2 (uint8_t *, int, uint8_t *, int )
;-----------------------------------------------------------------------------
xavs_pixel_sad_16x8_sse2:
    SAD_START_SSE2
    pxor    xmm0,   xmm0
    SAD_INC_4x16P_SSE2
    SAD_INC_4x16P_SSE2
...
ALIGN 16
;-----------------------------------------------------------------------------
;  void xavs_pixel_sad_x3_16x16_sse2( uint8_t *fenc, uint8_t *pix0, uint8_t *pix1,
;                                     uint8_t *pix2, int i_stride, int scores[3] )
;-----------------------------------------------------------------------------
%macro SAD_X 3
ALIGN 16
xavs_pixel_sad_x%1_%2x%3_sse2:
    SAD_X%1_2x%2P 1
%rep %3/2-1
    SAD_X%1_2x%2P 0
%endrep
...
ALIGN 16
;-----------------------------------------------------------------------------
;   int __cdecl xavs_pixel_ssd_16x16_sse2 (uint8_t *, int, uint8_t *, int )
;-----------------------------------------------------------------------------
xavs_pixel_ssd_16x16_sse2:
    SSD_START_SSE2
%rep 8
    SSD_INC_2x16P_SSE2
%endrep
...
ALIGN 16
;-----------------------------------------------------------------------------
;   int __cdecl xavs_pixel_ssd_16x8_sse2 (uint8_t *, int, uint8_t *, int )
;-----------------------------------------------------------------------------
xavs_pixel_ssd_16x8_sse2:
    SSD_START_SSE2
%rep 4
    SSD_INC_2x16P_SSE2
%endrep
...
ALIGN 16
;-----------------------------------------------------------------------------
;   int __cdecl xavs_pixel_satd_16x16_sse2 (uint8_t *, int, uint8_t *, int )
;-----------------------------------------------------------------------------
xavs_pixel_satd_16x16_sse2:
    SATD_START
...
ALIGN 16
;-----------------------------------------------------------------------------
;   int __cdecl xavs_pixel_satd_8x16_sse2 (uint8_t *, int, uint8_t *, int )
;-----------------------------------------------------------------------------
xavs_pixel_satd_8x16_sse2:
    SATD_START
...
ALIGN 16
;-----------------------------------------------------------------------------
;   int __cdecl xavs_pixel_satd_16x8_sse2 (uint8_t *, int, uint8_t *, int )
;-----------------------------------------------------------------------------
xavs_pixel_satd_16x8_sse2:
    SATD_START
...
ALIGN 16
;-----------------------------------------------------------------------------
;   int __cdecl xavs_pixel_satd_8x8_sse2 (uint8_t *, int, uint8_t *, int )
;-----------------------------------------------------------------------------
xavs_pixel_satd_8x8_sse2:
    SATD_START
...
ALIGN 16
;-----------------------------------------------------------------------------
;   int __cdecl xavs_pixel_satd_8x4_sse2 (uint8_t *, int, uint8_t *, int )
;-----------------------------------------------------------------------------
xavs_pixel_satd_8x4_sse2:
    SATD_START
