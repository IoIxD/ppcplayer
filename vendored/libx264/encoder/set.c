...
void x264_sps_init(x264_sps_t *sps, int i_id, x264_param_t *param)
{
    ...
    sps->i_chroma_format_idc = csp >= X264_CSP_I444 ? CHROMA_444 : csp >= X264_CSP_I422 ? CHROMA_422
                                                               : csp >= X264_CSP_I420   ? CHROMA_420
                                                                                        : CHROMA_400;
    ...
    sps->vui.i_num_reorder_frames = param->i_bframe_pyramid ? 2 : param->i_bframe ? 1
                                                                                  : 0;
    ...
    sps->vui.b_fullrange = (param->vui.b_fullrange >= 0 && param->vui.b_fullrange <= 1 ? param->vui.b_fullrange : (csp >= X264_CSP_BGR ? 1 : 0));
    ...
    sps->vui.i_colmatrix = (param->vui.i_colmatrix >= 0 && param->vui.i_colmatrix <= 14 ? param->vui.i_colmatrix : (csp >= X264_CSP_BGR ? 0 : 2));
...
int x264_validate_levels(x264_t *h, int verbose)
{
    ...
    int cbp_factor = h->sps->i_profile_idc >= PROFILE_HIGH422 ? 16 : h->sps->i_profile_idc == PROFILE_HIGH10 ? 12
                                                                 : h->sps->i_profile_idc == PROFILE_HIGH     ? 5
                                                                                                             : 4;
